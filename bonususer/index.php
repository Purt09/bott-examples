...
$bot_user_id = $_GET['bot_user_id'] ?? null;
$coef = $_GET['coef'] ?? null;

if ($bot_id === null || $bot_id === '' || $token === null || $token === '' || $bot_user_id === null || $bot_user_id === '' || $coef === null || $coef === '') {
...
if ($order_id === null || $order_id === '') {
    app_log('error', ['reason' => 'missing_order_id', 'bot_id' => $bot_id, 'recipient_user_id' => $bot_user_id]);
